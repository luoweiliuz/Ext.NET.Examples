    ...
    <ext:FormPanel 
        ...
        <Items>
            ...
            <ext:FieldContainer 
                ...
                <Items>
                    <ext:TextField runat="server" Width="150" Margins="0 3 0 0" />
                    <ext:DateField runat="server" Width="150" Margins="0 3 0 0" />
                    <ext:Toolbar 
                        runat="server" 
                        Flex="1"                         
                        Flat="true">
            ...
            <ext:FieldContainer 
                ...
                Layout="HBoxLayout">
                <Items>
                    <ext:NumberField runat="server" Width="40" Margins="0 3 0 0" />
                    <ext:DisplayField runat="server" Text="." Cls="dot-label" />
                    <ext:NumberField runat="server" Width="40"  Margins="0 3 0 3" />
                    <ext:DisplayField runat="server" Text="." Cls="dot-label" />
                    <ext:NumberField runat="server" Width="40"  Margins="0 3 0 3" />
                    <ext:DisplayField runat="server" Text="." Cls="dot-label" />
                    <ext:NumberField runat="server" Width="40"  Margins="0 0 0 3"/>
                </Items>
            </ext:FieldContainer>
            ...
            <ext:FieldContainer runat="server" Layout="AnchorLayout" Cls="note">
                <Items>
                    <ext:FieldContainer 
                        ...
                        Layout="HBoxLayout">
                        <Items>
                            <ext:TextField runat="server" Margins="0 3 0 0" />
                            <ext:TextField runat="server" Margins="0 3 0 0" />
                            <ext:TextField runat="server" Margins="0 3 0 0" />
                        </Items>
                    </ext:FieldContainer>
            ...
            <ext:FieldContainer 
                ...
                Layout="HBoxLayout">
                <Items>
                    <ext:TextField runat="server" Note="Note" Margins="0 3 0 0"/>
                    <ext:TextField runat="server" Note="Note" Margins="0 3 0 0"/>
                    <ext:TextField runat="server" Note="Note" Margins="0 3 0 0"/>
                </Items>
            </ext:FieldContainer>
