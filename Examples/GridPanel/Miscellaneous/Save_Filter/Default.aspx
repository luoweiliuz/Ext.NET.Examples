...
<script runat="server">
    ...
    protected void BeforeStoreChanged(object sender, BeforeStoreChangedEventArgs e)
    {
        ...
        List<Dictionary<string, string>> data = e.DataHandler.ObjectData<Dictionary<string, string>>();
        ...
        <ext:GridPanel 
            ...
            <ColumnModel runat="server">
                <Columns>
                    ...
                    <ext:Column runat="server" Text="Price (editable)" DataIndex="price">
            ...
            <Buttons>
                <ext:Button runat="server" Text="Save: filter fields (exclude 'Last Update')">
                    <Listeners>
                        <Click Handler="if (!#{Store1}.isDirty()) {alert('Please change cell\'s value first');} #{Store1}.sync({ filterField : function (r,name, value) { return name != 'lastChange'; }});" />
                    </Listeners>
                </ext:Button>
                
                <ext:Button runat="server" Text="Submit: filter records (exclude odd records)">
                    <Listeners>
                        <Click Handler="#{Store1}.submitData({ filterRecord : function (r) { return (r.stores[0].indexOf(r) % 2) == true; }});" />
                    </Listeners>
                </ext:Button>
            </Buttons>
        </ext:GridPanel>          
