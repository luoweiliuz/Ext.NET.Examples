...
//    });
    ...
    items.push({
        ...
        store: store,
        columns: [
            {id:'company', text: "Company", width: 160, sortable: true, dataIndex: 'company', flex: 1},
            {text: "Price", width: 75, sortable: true, renderer: 'usMoney', dataIndex: 'price'},
            {text: "Change", width: 75, sortable: true, dataIndex: 'change'},
    ...
    var listView = new Ext.list.ListView({
        ...
        columns: [
            {id:'company', text: "Company", width: .5, sortable: true, dataIndex: 'company'},
            {text: "Price", width: .25, sortable: true, tpl: '{price:usMoney}', dataIndex: 'price'},
