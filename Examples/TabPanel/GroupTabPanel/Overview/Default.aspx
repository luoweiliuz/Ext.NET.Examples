...
<body>
    ...
    <ext:Viewport runat="server" Layout="BorderLayout">
        <Items>
                                    ...
                                    <ext:GridPanel 
                                        ...
                                        <ColumnModel runat="server">
                                            <Columns>
                                                ...
                                                <ext:Column runat="server" Text="Change" Sortable="true" DataIndex="change">
                                                    <Renderer Fn="change" />
                                                </ext:Column>
                                                <ext:Column runat="server" Text="Change" Sortable="true" DataIndex="pctChange">
                                                    <Renderer Fn="pctChange" />
                                                </ext:Column>
                                                <ext:DateColumn runat="server" Text="Last Updated" Sortable="true" DataIndex="lastChange" />
                                            </Columns>
                                        </ColumnModel>
                                        <SelectionModel>
            ...
            <ext:Panel runat="server" Region="South" Margins="5 10 10 10" ButtonAlign="Left" BodyBorder="0">
                <TopBar>
