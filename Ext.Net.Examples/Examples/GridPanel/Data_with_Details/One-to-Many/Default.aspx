                        ...
                        <ext:GridPanel 
                            ...
                            <ColumnModel runat="server">
                                <Columns>
                                    ...
                                    <ext:Column runat="server" DataIndex="QuantityPerUnit" Text="Quantity Per Unit" />
                                    <ext:Column runat="server" DataIndex="UnitPrice" Text="Unit Price" />
                                    <ext:Column runat="server" DataIndex="UnitsInStock" Text="Units In Stock" />
                                    <ext:Column runat="server" DataIndex="UnitsOnOrder" Text="Units On Order" />
