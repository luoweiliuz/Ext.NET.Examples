    ...
    <ext:GridPanel 
        ...
        <ColumnModel runat="server">
            <Columns>
                ...
                <ext:RatingColumn Text="Rating" DataIndex="rating1" />
                <ext:RatingColumn Text="Editable" DataIndex="rating2" RoundToTick="false" Editable="true" />
                <ext:RatingColumn Text="Custom" DataIndex="rating3" SelectedCls="number-selected" UnselectedCls="number-unselected" />
            </Columns>
        </ColumnModel>       
    </ext:GridPanel>          
</body>
