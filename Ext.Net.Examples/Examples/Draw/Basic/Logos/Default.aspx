                                ...
                                <ext:DrawComponent runat="server" ViewBox="true" AutoSize="true">
                                    <Gradients>
                                        <ext:Gradient GradientID="blackblue" Angle="90">
                                            <Stops>
                                                <ext:GradientStop Offset="0" Color="rgb(33, 33, 33)" />
                                                <ext:GradientStop Offset="100" Color="rgb(156, 178, 248)" />
                                            </Stops>
                                        </ext:Gradient>
                                    </Gradients>
                                    <Items>
                                        <ext:Sprite Type="Path" Fill="url(#blackblue)" Path="<%# SAFARI_PATH %>" AutoDataBind="true" />
                                    </Items>
                                </ext:DrawComponent>
                            </Items>
                        </ext:Panel>
                                ...
                                <ext:DrawComponent runat="server" ViewBox="true" AutoSize="true">
                                    <Gradients>
                                        <ext:Gradient GradientID="grad1" Angle="100">
                                            <Stops>
                                                <ext:GradientStop Offset="0" Color="#AACE36" />
                                                <ext:GradientStop Offset="100" Color="#2FA042" />
                                            </Stops>
                                        </ext:Gradient>

                                        <ext:Gradient GradientID="grad2" Angle="21">
                                            <Stops>
                                                <ext:GradientStop Offset="0" Color="#79A933" />
                                                <ext:GradientStop Offset="13" Color="#70A333" />
                                                <ext:GradientStop Offset="34" Color="#559332" />
                                                <ext:GradientStop Offset="58" Color="#277B2F" />
                                                <ext:GradientStop Offset="86" Color="#005F27" />
                                                <ext:GradientStop Offset="100" Color="#005020" />
                                            </Stops>
                                        </ext:Gradient>

                                        <ext:Gradient GradientID="grad3" Angle="55">
                                            <Stops>
                                                <ext:GradientStop Offset="0" Color="#79AB35" />                                                
                                                <ext:GradientStop Offset="53" Color="#7CBA3D" />
                                                <ext:GradientStop Offset="100" Color="#00AA4B" />
                                            </Stops>
                                        </ext:Gradient>
                                    </Gradients>
                                    <Items>
                                        <ext:Sprite Type="Path" Fill="#C5D83E" Path="<%# SENCHA_PATH1 %>" AutoDataBind="true" />
                                        <ext:Sprite Type="Path" Fill="url(#grad1)" Path="<%# SENCHA_PATH2 %>" AutoDataBind="true" />
                                        <ext:Sprite Type="Path" Fill="url(#grad2)" Path="<%# SENCHA_PATH3 %>" AutoDataBind="true" />
                                        <ext:Sprite Type="Path" Fill="url(#grad3)" Path="<%# SENCHA_PATH4 %>" AutoDataBind="true" />
                                    </Items>
                                </ext:DrawComponent>
                            </Items>
                        </ext:Panel>
                        ...
                        <ext:Panel runat="server" Title="Firefox" Layout="FitLayout">
                            <Items>
                                <ext:DrawComponent runat="server" ViewBox="true">
                                    ...
                                    <Items>
                                        <ext:Sprite Type="Path" Fill="url(#blackblue)" Path="<%# FIREFOX_PATH %>" AutoDataBind="true" />
                                    </Items>
                                </ext:DrawComponent>
                            </Items>
                        </ext:Panel>
                        ...
                        <ext:Panel runat="server" Title="Explorer" Layout="FitLayout">
                            <Items>
                                <ext:DrawComponent runat="server" ViewBox="true">
                                    ...
                                    <Items>
                                        <ext:Sprite Type="Path" Fill="url(#blackblue)" Path="<%# IE_PATH %>" AutoDataBind="true" />
                                    </Items>
                                </ext:DrawComponent>
                            </Items>
                        </ext:Panel>
                        ...
                        <ext:Panel runat="server" Title="Chrome" Layout="FitLayout">
                            <Items>
                                <ext:DrawComponent runat="server" ViewBox="true">
                                    ...
                                    <Items>
                                        <ext:Sprite Type="Path" Fill="url(#blackblue)" Path="<%# CHROME_PATH %>" AutoDataBind="true" />
                                    </Items>
                                </ext:DrawComponent>
                            </Items>
                        </ext:Panel>
                        ...
                        <ext:Panel runat="server" Title="Opera" Layout="FitLayout">
                            <Items>
                                <ext:DrawComponent runat="server" ViewBox="true">
                                    ...
                                    <Items>
                                        <ext:Sprite Type="Path" Fill="url(#blackblue)" Path="<%# OPERA_PATH %>" AutoDataBind="true" />
                                    </Items>
                                </ext:DrawComponent>
                            </Items>
                        </ext:Panel>
